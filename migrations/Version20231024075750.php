 ...
 */
final class Version20231024075750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD categorie_id INT NOT NULL, ADD auteur_id INT NOT NULL, DROP auteur, DROP commentaires');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD auteur VARCHAR(255) NOT NULL, ADD commentaires LONGTEXT DEFAULT NULL, DROP categorie_id, DROP auteur_id');
    }
}
